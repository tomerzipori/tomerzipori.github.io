...
<main class="site-main"><section class="page-intro"><p class="section-number">Article · Evidence and belief</p><h1>Rejecting the null hypothesis or not?</h1><div class="article-meta"><span class="status">Published</span><span>04 Sep 2023</span></div></section><article class="prose real-post"><p>In the current post I try to explain what appears to be a paradox: given identical data, different schools of statistics disagree about the appropriate conclusion.</p>
...
{{< include ../../_generated/article-p_values_paradox.html >}}
