...
<main class="site-main"><section class="page-intro"><p class="section-number">Article · Evidence and belief</p><h1>US Presidential Elections — A Bayesian Perspective</h1><div class="article-meta"><span class="status">Published</span><span>12 Jan 2025</span></div></section><article class="prose real-post"><section id="setup" class="level1">
<h1>Setup</h1>
<div class="cell">
...
{{< include ../../_generated/article-elections2024.html >}}
